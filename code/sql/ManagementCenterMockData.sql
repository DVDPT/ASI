...
insert into Customer values('add','a@a.pt')
insert into Customer values('add1','b@a.pt')
insert into Customer values('add2','c@a.pt')
insert into Customer values('add3','c@a.pt')